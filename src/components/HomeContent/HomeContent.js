    ...
    setTimeout(() => {
      ...
      if (svgLines.length === tableRows.length) {
        let tableRow = chartTable.current.querySelector("tbody tr"),
          ...
          tableRowHeight = parseFloat(window.getComputedStyle(tableRow).blockSize),
        ...
        gsap
          ...
          .fromTo("#motionPath1", drawSVGTime, { drawSVG: "0%", ease: "power4.out" }, { opacity: 1, drawSVG: "100%", ease: "power4.out" }, '<')
          .to("#motionPath1", 0, { opacity: 0 })
          .to(tableRowBg, moveBGTime, { y: `+=${tableRowHeight}` })
          .fromTo("#motionPath2", drawSVGTime, { drawSVG: "0%", ease: "power4.out" }, { opacity: 1, drawSVG: "100%", ease: "power4.out" }, '<')
          .to("#motionPath2", 0, { opacity: 0 })
          .to(tableRowBg, moveBGTime, { y: `+=${tableRowHeight}` })
          .fromTo("#motionPath3", drawSVGTime, { drawSVG: "0%", ease: "power4.out" }, { opacity: 1, drawSVG: "100%", ease: "power4.out" }, '<')
          .to("#motionPath3", 0, { opacity: 0 })
          .to(tableRowBg, moveBGTime, { y: `+=${tableRowHeight}` })
          .fromTo("#motionPath4", drawSVGTime, { drawSVG: "0%", ease: "power4.out" }, { opacity: 1, drawSVG: "100%", ease: "power4.out" }, '<')
        ...
        <section className="section-top">
          ...
          <Container>
            <div className="section-top-desc">
              ...
              <Link className="el-button outline" to={"/about"}>
                Invest with us
              </Link>
            </div>
          ...
          <span className="section-join--bg">
            <Picture
              imgS2x={[
                {
                  type: "png",
                  name: images[`join@2x.png`],
                },
                {
                  type: "webp",
                  name: images["join@2x.webp"],
                },
              ]}
              imgS1920={[
                {
                  type: "png",
                  name: images[`join.png`],
                },
                {
                  type: "webp",
                  name: images["join.webp"],
                },
              ]}
              imgS1440={[
                {
                  type: "png",
                  name: images[`join@1440.png`],
                },
                {
                  type: "webp",
                  name: images["join@1440.webp"],
                },
              ]}
              imgS1024={[
                {
                  type: "png",
                  name: images[`join@1024.png`],
                },
                {
                  type: "webp",
                  name: images["join@1024.webp"],
                },
              ]}
              imgS768={[
                {
                  type: "png",
                  name: images[`join@768.png`],
                },
                {
                  type: "webp",
                  name: images["join@768.webp"],
                },
              ]}
              imgS640={[
                {
                  type: "png",
                  name: images[`join@640.png`],
                },
                {
                  type: "webp",
                  name: images["join@640.webp"],
                },
              ]}
              desc={"desc"}
            />
        ...
        <section className="section-general">
          <div className="section-general-category">
            ...
            <Container>
              ...
              <Link className="section-general-link" to="/">
